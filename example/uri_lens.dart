...
void main() {
  ...
  final searchUri = Uri.parse('https://api.example.com/search?q=dart&limit=10&page=1&debug=true');
  ...
  final stepByStep = Query.required('search')
  ...
  try {
    ...
    print('Caught expected error for missing required parameter: ${e.failures.first}');
  }
  ...
  final missingWithDefault = Query.defaulted('missing', 'default-value')(emptyUri);
